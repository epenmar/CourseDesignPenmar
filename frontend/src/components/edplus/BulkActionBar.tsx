...
export default function BulkActionBar({
  ...
  const placementClass = {
    sticky: "sticky bottom-4 z-20 mx-4",
    fixed: "fixed bottom-4 left-4 right-4 z-50 mx-auto max-w-6xl lg:left-[calc(var(--app-nav-width)+1rem)]",
    inline: "",
  }[placement];
